...
public class RebuildableTreeMap<K, V> implements Map<K, V> {
	private Map<K, V> d_nested;

	public RebuildableTreeMap() {
		d_nested = new TreeMap<K, V>();
	}
	
	public RebuildableTreeMap(Map<? extends K, ? extends V> m) {
		d_nested = new TreeMap<K,V>(m);
	}
