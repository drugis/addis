...
public class FileNames {
	...
	public static final String ICON_BENEFITRISK_NEW = "benefitrisk_new.gif";
	...
	public static final String WELCOME_HEADER = "header.png";
	public static final String WELCOME_FOOTER = "footer.png";
}
