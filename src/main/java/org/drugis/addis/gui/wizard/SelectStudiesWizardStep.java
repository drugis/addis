...
public class SelectStudiesWizardStep extends PanelWizardStep {
	...
	public SelectStudiesWizardStep(AbstractMetaAnalysisWizardPM<?> pm, AddisWindow mainWindow) {
		...
		final EnhancedTable table = EnhancedTable.createWithSorterAndAutoSize(new SelectableStudyCharTableModel(pm.getStudyListModel(), mainWindow.getPresentationModelFactory()));
