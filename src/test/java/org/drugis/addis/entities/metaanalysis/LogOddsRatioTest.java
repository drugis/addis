...
public class LogOddsRatioTest {
	...
	public void testGetMean() {
		assertEquals(1.36, Math.exp(d_ratioBennie.getMedian()), 0.01);
		assertEquals(1.03, Math.exp(d_ratioBoyer.getMedian()), 0.01); 
		assertEquals(1.65, Math.exp(d_ratioFava.getMedian()), 0.01);
		assertEquals(1.11, Math.exp(d_ratioNewhouse.getMedian()), 0.01);
		assertEquals(1.56, Math.exp(d_ratioSechter.getMedian()), 0.01); 
	}
