 ...
 */
		...
		assertMeanwithinTenPercent(1.187, 0.904, 1.558,mtm.getValueAt(0, 1));
		assertMeanwithinTenPercent(1.269, 1.001, 1.610,mtm.getValueAt(1, 1));
		assertMeanwithinTenPercent(1.357, 1.103, 1.669,mtm.getValueAt(2, 1));
		
		assertMeanwithinTenPercent(0.574, 0.132, 2.496,mtm.getValueAt(0, 2));
		assertMeanwithinTenPercent(3.305, 0.772, 14.145,mtm.getValueAt(1, 2));
		assertMeanwithinTenPercent(0.494, 0.091, 2.683,mtm.getValueAt(2, 2));
		
		assertMeanwithinTenPercent(1.654, 0.696, 3.931,mtm.getValueAt(0, 3));
		assertMeanwithinTenPercent(0.689, 0.321, 1.479,mtm.getValueAt(1, 3));
		assertMeanwithinTenPercent(2.844, 1.625, 4.977,mtm.getValueAt(2, 3));
		
		assertMeanwithinTenPercent(0.831, 0.441, 1.565,mtm.getValueAt(0, 4));
		assertMeanwithinTenPercent(1.318, 0.702, 2.477,mtm.getValueAt(1, 4));
		assertMeanwithinTenPercent(0.647, 0.333, 1.258,mtm.getValueAt(2, 4));
		
		assertMeanwithinTenPercent(1.253, 0.342, 4.594,mtm.getValueAt(0, 5));
		assertMeanwithinTenPercent(1.856, 0.432, 7.976,mtm.getValueAt(1, 5));
		assertMeanwithinTenPercent(1.140, 0.294, 4.415,mtm.getValueAt(2, 5));
		
		assertMeanwithinTenPercent(1.401, 0.831, 2.364,mtm.getValueAt(0, 6));
		assertMeanwithinTenPercent(1.348, 0.770, 2.360,mtm.getValueAt(1, 6));
		assertMeanwithinTenPercent(1.877, 1.153, 3.055,mtm.getValueAt(2, 6));
	}
