...
public class NetworkTableModelTest {
	...
	public void testValueAt() {
		...
		ConsistencyWrapper<TreatmentDefinition> consModel = d_analysis.getConsistencyModel();
	...
	public void testUpdateFiresTableDataChangedEvent() throws InterruptedException {
		ConsistencyWrapper<TreatmentDefinition> model =  d_analysis.getConsistencyModel();
