...
public class NetworkMetaAnalysisWizardPMTest {
	...
	public void testDrugsSelectedCompleteListener() {
		...
		ArrayList<TreatmentCategorySet> newList = new ArrayList<TreatmentCategorySet>();
		...
		newList = new ArrayList<TreatmentCategorySet>(newList);
	...
	public void testStudyListModel() {
		...
		ArrayList<TreatmentCategorySet> selectionList = new ArrayList<TreatmentCategorySet>();
	...
	public void testStudyListModelAdds() {
		...
		d_pm.getSelectedDrugsModel().clear();
		d_pm.getSelectedDrugsModel().addAll(new ArrayList<TreatmentCategorySet>(selectionList));
	...
	public void testIncludeOnlyDrugsMeasuredInSomeStudy() {
		...
		TreatmentCategorySet[] expected = new TreatmentCategorySet[] {
				TreatmentCategorySet.createTrivial(ExampleData.buildDrugCitalopram()),
				d_fluoxSet,
				d_paroxSet
			};
	...
	public void testCreateMetaAnalysis() {
		...
		d_pm.getOutcomeMeasureModel().setValue(ExampleData.buildEndpointHamd());
		d_pm.getSelectedDrugsModel().clear();
		d_pm.getSelectedDrugsModel().addAll(Arrays.asList(new TreatmentCategorySet[] {
				d_fluoxSet,
				d_paroxSet,
				d_sertrSet}));
		...
		for (Study s : ma.getIncludedStudies()) {
			for (TreatmentCategorySet d : s.getDrugs()) {
