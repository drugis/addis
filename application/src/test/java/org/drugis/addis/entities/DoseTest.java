...
public class DoseTest {
	...
	public void testEquals() {
		...
		assertEquals(new FixedDose(q1, DoseUnit.createMilliGramsPerDay()).hashCode(),
				new FixedDose(q1, DoseUnit.createMilliGramsPerDay()).hashCode());
	}
	...
	public void testEqualsFlexible() {
		...
		assertEquals(new FlexibleDose(q1, DoseUnit.createMilliGramsPerDay()),
				new FlexibleDose(q1, DoseUnit.createMilliGramsPerDay()));
		...
		assertEquals(new FlexibleDose(q1, DoseUnit.createMilliGramsPerDay()).hashCode(),
				new FlexibleDose(q1, DoseUnit.createMilliGramsPerDay()).hashCode());
	}
