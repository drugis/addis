...
public class DoseQuantityChoiceNode extends ChoiceNode {
	...
	private PropertyDescriptor d_unitDescriptor;

	public DoseQuantityChoiceNode(Class<?> beanClass, String propertyName, DoseUnit doseUnit) {
		super(beanClass, propertyName);
		try {
			d_unitDescriptor = new PropertyDescriptor(AbstractDose.PROPERTY_DOSE_UNIT, beanClass);
	...
	public Object getValue(Object obj) {
		...
		return DoseUnit.convert(value, (DoseUnit) BeanUtils.getValue(obj, d_unitDescriptor), d_doseUnit);
	}
